...
public class Metal_FS121M_detailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("FS-121M");
        ...
        webView.loadUrl("http://mp.weixin.qq.com/s/J9HmiaxQ6MlYTYskWrCqaQ");
