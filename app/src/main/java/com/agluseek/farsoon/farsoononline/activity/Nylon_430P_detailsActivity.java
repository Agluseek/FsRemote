...
public class Nylon_430P_detailsActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("403P系列");
        ...
        webView.loadUrl("http://mp.weixin.qq.com/s/23y-DsSj1VWAzB_9OzU5-A");
    }
