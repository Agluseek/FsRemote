...
public class FS_GH3536_Metal_detailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("镍基高温合金粉末FS GH3536");
        ...
        iv.setImageResource(R.mipmap.fs_gh3536);
        title_tv.setText("3D打印镍基高温合金某航空样件");
        feature_content.setText("具有很高的抗拉伸强度、抗蠕变破裂强度和抗疲劳强度，以及良好的延展性和韧性，其抗氧化能力和耐热腐蚀性能也十分优异。");
        apply_content.setText("主要用于航空航天、石油天然气开采、石油化工等行业。" );
